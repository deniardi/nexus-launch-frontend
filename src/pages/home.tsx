...
const HomePage: React.FC = () => {
  return (
    <Layout>
      <SEO
        title="Nexus Launch - Create and Trade Tokens with Bonding Curves"
        description="Launch and trade tokens effortlessly using innovative bonding curve technology. Experience fair, dynamic, and continuous liquidity on Nexus Testnet3."
      ...
      <div className="bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 min-h-screen">
        ...
        <section className="py-12 sm:py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-2xl sm:text-3xl font-bold text-center text-blue-400 mb-8 sm:mb-12">Why Choose Nexus Launch?</h2>
        ...
        <section className="py-12 sm:py-16">
          <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-lg sm:text-xl text-gray-400 mb-6 sm:mb-8">Join Nexus Launch today and experience the future of decentralized finance.</p>
