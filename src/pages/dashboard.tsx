...
const TokenBalanceItem: React.FC<{ 
  ...
  const handleAddressClick = (e: React.MouseEvent) => {
    e.stopPropagation();
    window.open(`https://nexus.testnet.blockscout.com/address/${tokenAddress}`, '_blank');
  };
...
const UserDashboard: React.FC = () => {
  ...
  return (
    <Layout>
      <SEO
        title="Your Token Dashboard - Nexus Launch"
        description="Manage your tokens and track your transactions in one place. Your personal Nexus Launch dashboard."
        image="seo/dash.jpg"
      />
