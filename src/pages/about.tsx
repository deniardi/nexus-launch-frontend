  ...
  return (
    <Layout>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <h1 className="text-xl sm:text-2xl font-bold text-white mb-8 text-center">About Nexus Launch</h1>

        <div className="mb-12">
          <div className="bg-[var(--card)] rounded-lg p-6 md:p-8">
            <h2 className="text-base sm:text-lg font-semibold text-white mb-4">What is Nexus Launch?</h2>
            <div className="text-gray-400 text-xs sm:text-sm leading-relaxed space-y-4">
              <p>
                Nexus Launch is a revolutionary decentralized platform that empowers individuals to create and trade tokens using innovative bonding curve technology on the Nexus Testnet3 network.
              </p>
