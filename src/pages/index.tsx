...
const Home: React.FC = () => {
  ...
  return (
    <Layout>
      <SEO
        title="Create and Trade Memecoins Easily on Nexus Launch."
        description="The ultimate platform for launching and trading memecoins on Nexus Testnet3. Create your own tokens effortlessly and engage in fair, dynamic trading."
        image="seo/home.jpg"
      />
      <HowItWorksPopup isVisible={showHowItWorks} onClose={() => setShowHowItWorks(false)} />
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-4">
          <div className="min-h-[60px] md:min-h-[80px]"> {/* Responsive height */}
            <h1 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold mb-0.5 md:mb-1">{displayText.heading}</h1>
            <h2 className="text-base sm:text-lg md:text-xl lg:text-2xl mb-2 md:mb-3">{displayText.subheading}</h2>
          </div>
