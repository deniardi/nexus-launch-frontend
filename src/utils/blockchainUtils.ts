...
// Extract only the ABI array from Hardhat artifacts
const BondingCurveManagerABI = (BondingCurveManagerArtifact as any).abi;
const ERC20ABI = (ERC20Artifact as any).abi;
...
export function getExplorerUrl(txHash: string): string {
  return `https://nexus.testnet.blockscout.com/tx/${txHash}`;
}
